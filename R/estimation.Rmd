...
- TODO: Currently, without composition change!

```{r}
data <- sienaDataCreate(net, devActLogVar,
                        depsUpLogVar, depsDownLogVar, comIntLogVar, relActLogVar, ageLogVar,
                        depUpDyad, depDownDyad,
                        nodeSets = list(devs, pkgs))
# saveRDS(data, "data/sienaData_new.rds")
...
```{r}
algorithm <- sienaAlgorithmCreate(projname='hicss-2023-new',
                                  seed=17,
